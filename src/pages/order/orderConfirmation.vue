<template>
  <div class="order-confirm">
    <order-header title="订单确认" tips="请认真填写收货地址！"></order-header>
        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked':index === checkedAddressIndex}"
                   @click="checkedAddressIndex=index"
          ...
          <div class="detail">
            <div class="item">
              ...
              <span class="item-val">{{ goodsCount }}件</span>
            </div>
            <div class="item">
...
export default {
  ...
  data() {
    return {
      ...
      checkedAddressIndex: 0//当前收货地址选中索引
    }
  },
  components: {
    OrderHeader,
  ...
  methods: {
    ...
    // 订单提交
    orderSubmit() {
      let item = this.addressList[this.checkedAddressIndex];
      if (!item) {
